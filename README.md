...
|---------|----------|-----------|--------|----------|
| MATRES  | 85.4%    | 82.3%     | 84.6%  | 83.4%    |
| TempEval-3 | 78.2% | 76.8%     | 79.1%  | 77.9%    |
...
```bibtex
@software{temporal_relation_extraction,
  author = {Harshit},
  title = {Temporal Relation Extraction with BERT and Graph Attention Networks},
  url = {https://github.com/ahv15/TemporalRelationExtraction},
  year = {2023}
}
```
...
**Harshit** - [GitHub Profile](https://github.com/ahv15)

- **Repository**: [TemporalRelationExtraction](https://github.com/ahv15/TemporalRelationExtraction)
- **Issues**: [Report bugs or request features](https://github.com/ahv15/TemporalRelationExtraction/issues)
- **Documentation**: See module docstrings and this README
